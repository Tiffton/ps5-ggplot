...
gapminder %>% 
  ...
  ggplot() +
  geom_point(aes(lifeExpectancy, GDP_PC, color = region, size = totalPopulation)) +
  labs(title = "2019 GDP PerCap. vs Life Expectancy", x = "Life Expectancy (Yr)", 
       y = "GDP Per Capita (Constant 2010 US$)", color ="Continent", size = "Country \n Size")
```



The scatter plot suggests that countries across diffferent continents have closer in life expectancy.
However theres is still a gap in GDP per capita depending on the Continent. For exmaple, 
countries in Europe have highest GDP per capita and life expectancy, while, countries in Africa 
have lower life expectancy and lowest GDP per capita. _Edit this_ 
...
gapminder %>% 
  ...
  labs(title = "CDP Per Capita for years of 1960 & 2019", x = "CDP_PC (Constant US 2010$)",
       y = "Count", fill = "Year")
...
I spent 8 hours opn this assingment 
